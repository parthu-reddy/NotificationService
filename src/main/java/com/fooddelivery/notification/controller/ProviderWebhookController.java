...
public class ProviderWebhookController {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ProviderWebhookController.class);
    ...
    public ResponseEntity<Void> handleExotelCallback(@RequestParam Map<String, String> payload, @RequestParam(value = "token", required = false) String token) {
