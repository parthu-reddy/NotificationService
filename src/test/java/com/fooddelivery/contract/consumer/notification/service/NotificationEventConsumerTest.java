package com.fooddelivery.contract.consumer.notification.service;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.NONE, classes = com.fooddelivery.notification.NotificationServiceApplication.class)
...
public class NotificationEventConsumerTest {
    ...
    @org.springframework.boot.test.mock.mockito.MockBean
    private io.github.bucket4j.distributed.proxy.ProxyManager<String> lettuceProxyManager;
    ...
    public void testConsumerIsWorking() {
        try {
            stubTrigger.trigger("trigger-notification-dispatch");
        } catch (Exception e) {
