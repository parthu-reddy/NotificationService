...
public class OpenApiGenerationTest {
    ...
    private com.fooddelivery.notification.service.AuditLogService auditLogService;


    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.notification.repository.UserDeviceRepository userDeviceRepository;

    @org.springframework.boot.autoconfigure.SpringBootApplication(scanBasePackages = {"com.fooddelivery.notification.controller"}, excludeName = {"org.springframework.boot.autoconfigure.security.servlet.SecurityAutoConfiguration", "org.springframework.boot.actuate.autoconfigure.security.servlet.ManagementWebSecurityAutoConfiguration", "org.springframework.boot.autoconfigure.security.reactive.ReactiveSecurityAutoConfiguration", "org.springframework.boot.actuate.autoconfigure.security.reactive.ManagementReactiveSecurityAutoConfiguration", "org.springframework.boot.autoconfigure.security.oauth2.resource.servlet.OAuth2ResourceServerAutoConfiguration"})
    ...
    @MockBean
    private com.fooddelivery.notification.config.NotificationTemplateSeeder notificationTemplateSeeder;
